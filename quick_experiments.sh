...
python main_ppo.py --preprocessed-data processed_data.pkl --device cuda --total-timesteps 50000 --max-windows 2 2>&1 | tee experiments/exp1_low_lr.log
...
python main_ppo.py --preprocessed-data processed_data.pkl --device cuda --total-timesteps 50000 --max-windows 2 2>&1 | tee experiments/exp2_small_batch.log
cp config_ppo.py.backup config_ppo.py
...
python main_ppo.py --preprocessed-data processed_data.pkl --device cuda --total-timesteps 50000 --max-windows 2 2>&1 | tee experiments/exp3_combo.log
cp config_ppo.py.backup config_ppo.py
